...
# Hiển thị thông tin xe gọn gàng, không tiêu đề, không index
...
# Hiển thị dạng bảng không header, không index
...
st.dataframe(
    ...
    column_config={
        0: st.column_config.Column("", width="small"),
        1: st.column_config.Column("", width="medium")
    }
)
